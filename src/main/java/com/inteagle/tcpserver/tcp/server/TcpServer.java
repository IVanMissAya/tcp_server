package com.inteagle.tcpserver.tcp.server;
...
public abstract class TcpServer implements Runnable {
    ...
    private void startClient(final Socket socket) {
        SocketTransceiver client = new SocketTransceiver(socket) {
            ...
            @Override
            public void onReceive(InetAddress addr, String data) {
     ...
     * @param data
     */
    public abstract void onReceive(SocketTransceiver client, String data);
